var popupController = /** @class */ (function () {
    ...
    popupController.prototype.AddHiraganaLower = function () {
    ...
    popupController.prototype.AddHiraganaZo = function () {
    ...
    popupController.prototype.AddHiraganaYo = function () {
    ...
    popupController.prototype.AddKatakana = function () {
    ...
    popupController.prototype.AddKatakanaZo = function () {
    ...
    popupController.prototype.AddKatakanaYo = function () {
    ...
    popupController.prototype.RetrieveData = function (wordType) {
        var _this = this;
        var result = this.Words.filter(function (o) { return o.HkType == _this.HkType && o.WordType == wordType; });
        return result;
    };
    popupController.prototype.GetRelations = function (item) {
        var _this = this;
        var array = [];
        angular.forEach(item.Relations, function (value, key) {
            var find = _this.Words.filter(function (w) { return w.Id == value; })[0];
            array.push(find);
        });
        return array;
    };
...
var HkTypes;
(function (HkTypes) {
    HkTypes[HkTypes["H"] = 0] = "H";
    HkTypes[HkTypes["K"] = 1] = "K";
})(HkTypes || (HkTypes = {}));
var WordTypes;
(function (WordTypes) {
    WordTypes[WordTypes["Pure"] = 100] = "Pure";
